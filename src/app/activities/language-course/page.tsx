  ...
  return (
    <main className="min-h-screen bg-[#FDF1DD] dark:bg-[#1a1a1a]">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('./language/germany-bg.jpg')",
        }}
      >
        <div className="bg-black/40 w-full h-full flex items-center justify-center">

          <h1 className="text-4xl md:text-5xl font-semibold text-white text-center px-6">
      ...
      <section className="py-20 px-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#5C4A3A] dark:text-gray-300 mb-10 text-lg">
          ...
          <img
            src="./language/conversation.jpg"
            className="rounded-xl mb-10 w-full object-cover shadow-md"
          />


          {/* ABOUT */}

          <h2 className="text-2xl font-semibold mb-3 text-[#3A2A1F] dark:text-white">
          ...
          <ul className="list-disc ml-6 text-[#5C4A3A] dark:text-gray-300 mb-8 space-y-2">
          ...
          <div className="mt-8">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-lg hover:scale-105 transition-transform duration-200 font-medium shadow-md"
            >
